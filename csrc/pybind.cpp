...
#include "executor/reduced_shard_plan.h"
#include "executor/qwd_plan.h"
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("inplace_dequantize_gathered_add", &inplace_dequantize_gathered_add);
