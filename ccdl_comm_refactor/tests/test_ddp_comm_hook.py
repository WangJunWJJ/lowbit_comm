...
def test_create_ddp_comm_hook_falls_back_when_hierarchical_transport_missing() -> None:
    calls = []
    ...
    assert "hierarchical transport unavailable" in hook._ccdl_strategy_plan.reason
    assert calls == [
